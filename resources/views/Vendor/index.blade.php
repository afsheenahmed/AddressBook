...
<head>
    ...
    <!--favicon-->
    <link rel="icon" href="ven/images/favicon-32x32.png" type="image/png">
    <!-- loader-->
    <link href="ven/css/pace.min.css" rel="stylesheet">
    <script src="ven/js/pace.min.js"></script>

    <!--plugins-->
    <link href="ven/plugins/perfect-scrollbar/css/perfect-scrollbar.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="ven/plugins/metismenu/metisMenu.min.css">
    <link rel="stylesheet" type="text/css" href="ven/plugins/metismenu/mm-vertical.css">
    <link rel="stylesheet" type="text/css" href="ven/plugins/simplebar/css/simplebar.css">
    <!--bootstrap css-->
    <link href="ven/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans:wght@300;400;500;600&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Material+Icons+Outlined" rel="stylesheet">
    <!--main css-->
    <link href="ven/css/bootstrap-extended.css" rel="stylesheet">
...
<body>
        ...
        <nav class="navbar navbar-expand align-items-center gap-4">
                                ...
                                <div class="search-list d-flex flex-column gap-2">
                                    <div class="search-list-item d-flex align-items-center gap-3">
                                        <div class="memmber-img">
                                            <img src="ven/images/avatars/01.png" width="32" height="32" class="rounded-circle" alt="">
                                        </div>
                                        <div class="">
                                    ...
                                    <div class="search-list-item d-flex align-items-center gap-3">
                                        <div class="memmber-img">
                                            <img src="ven/images/avatars/02.png" width="32" height="32" class="rounded-circle" alt="">
                                        </div>
                                        <div class="">
                                    ...
                                    <div class="search-list-item d-flex align-items-center gap-3">
                                        <div class="memmber-img">
                                            <img src="ven/images/avatars/03.png" width="32" height="32" class="rounded-circle" alt="">
                                        </div>
                                        <div class="">
            ...
            <ul class="navbar-nav gap-1 nav-right-links align-items-center">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="avascript:;" data-bs-toggle="dropdown"><img src="ven/images/county/02.png" width="22" alt="">
          </a>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="ven/images/county/01.png" width="20" alt=""><span class="ms-2">English</span></a>
                        </li>
                        <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="ven/images/county/02.png" width="20" alt=""><span class="ms-2">Catalan</span></a>
                        </li>
                        <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="ven/images/county/03.png" width="20" alt=""><span class="ms-2">French</span></a>
                        </li>
                        <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="ven/images/county/04.png" width="20" alt=""><span class="ms-2">Belize</span></a>
                        </li>
                        <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="ven/images/county/05.png" width="20" alt=""><span class="ms-2">Colombia</span></a>
                        </li>
                        <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="ven/images/county/06.png" width="20" alt=""><span class="ms-2">Spanish</span></a>
                        </li>
                        <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="ven/images/county/07.png" width="20" alt=""><span class="ms-2">Georgian</span></a>
                        </li>
                        <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="ven/images/county/08.png" width="20" alt=""><span class="ms-2">Hindi</span></a>
                        </li>
                    </ul>
                </li>
                            ...
                            <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3 g-4 g-lg-5">
                                ...
                                <div class="col">
                                    <div class="card rounded-4 shadow-none border mb-0">
                                        <div class="card-body">
                                            <div class="d-flex align-items-start gap-3">
                                                <img src="ven/images/megaIcons/02.png" width="40" alt="">
                                                <div class="mega-menu-content">
                                                    <h5>Website</h5>
                                                    <p class="mb-0 f-14">In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document.</p>
                                                </div>
                                ...
                                <div class="col">
                                    <div class="card rounded-4 shadow-none border mb-0">
                                        <div class="card-body">
                                            <div class="d-flex align-items-start gap-3">
                                                <img src="ven/images/megaIcons/03.png" width="40" alt="">
                                                <div class="mega-menu-content">
                                                    <h5>Subscribers</h5>
                                                    <p class="mb-0 f-14">In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document.</p>
                                                </div>
                                ...
                                <div class="col">
                                    <div class="card rounded-4 shadow-none border mb-0">
                                        <div class="card-body">
                                            <div class="d-flex align-items-start gap-3">
                                                <img src="ven/images/megaIcons/01.png" width="40" alt="">
                                                <div class="mega-menu-content">
                                                    <h5>Hubspot</h5>
                                                    <p class="mb-0 f-14">In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document.</p>
                                                </div>
                                ...
                                <div class="col">
                                    <div class="card rounded-4 shadow-none border mb-0">
                                        <div class="card-body">
                                            <div class="d-flex align-items-start gap-3">
                                                <img src="ven/images/megaIcons/11.png" width="40" alt="">
                                                <div class="mega-menu-content">
                                                    <h5>Templates</h5>
                                                    <p class="mb-0 f-14">In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document.</p>
                                                </div>
                                ...
                                <div class="col">
                                    <div class="card rounded-4 shadow-none border mb-0">
                                        <div class="card-body">
                                            <div class="d-flex align-items-start gap-3">
                                                <img src="ven/images/megaIcons/13.png" width="40" alt="">
                                                <div class="mega-menu-content">
                                                    <h5>Ebooks</h5>
                                                    <p class="mb-0 f-14">In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document.</p>
                                                </div>
                                ...
                                <div class="col">
                                    <div class="card rounded-4 shadow-none border mb-0">
                                        <div class="card-body">
                                            <div class="d-flex align-items-start gap-3">
                                                <img src="ven/images/megaIcons/12.png" width="40" alt="">
                                                <div class="mega-menu-content">
                                                    <h5>Sales</h5>
                                                    <p class="mb-0 f-14">In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document.</p>
                                                </div>
                                ...
                                <div class="col">
                                    <div class="card rounded-4 shadow-none border mb-0">
                                        <div class="card-body">
                                            <div class="d-flex align-items-start gap-3">
                                                <img src="ven/images/megaIcons/08.png" width="40" alt="">
                                                <div class="mega-menu-content">
                                                    <h5>Tools</h5>
                                                    <p class="mb-0 f-14">In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document.</p>
                                                </div>
                                ...
                                <div class="col">
                                    <div class="card rounded-4 shadow-none border mb-0">
                                        <div class="card-body">
                                            <div class="d-flex align-items-start gap-3">
                                                <img src="ven/images/megaIcons/09.png" width="40" alt="">
                                                <div class="mega-menu-content">
                                                    <h5>Academy</h5>
                                                    <p class="mb-0 f-14">In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document.</p>
                                                </div>
                        ...
                        <div class="border rounded-4 overflow-hidden">
                            <div class="row row-cols-3 g-0 border-bottom">
                                <div class="col border-end">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="ven/images/apps/01.png" width="36" alt="">
                                        </div>
                                        <div class="app-name">
                                ...
                                <div class="col border-end">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="ven/images/apps/02.png" width="36" alt="">
                                        </div>
                                        <div class="app-name">
                                ...
                                <div class="col">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="ven/images/apps/03.png" width="36" alt="">
                                        </div>
                                        <div class="app-name">
                            ...
                            <div class="row row-cols-3 g-0 border-bottom">
                                <div class="col border-end">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="ven/images/apps/04.png" width="36" alt="">
                                        </div>
                                        <div class="app-name">
                                ...
                                <div class="col border-end">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="ven/images/apps/05.png" width="36" alt="">
                                        </div>
                                        <div class="app-name">
                                ...
                                <div class="col">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="ven/images/apps/06.png" width="36" alt="">
                                        </div>
                                        <div class="app-name">
                            ...
                            <div class="row row-cols-3 g-0 border-bottom">
                                <div class="col border-end">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="ven/images/apps/07.png" width="36" alt="">
                                        </div>
                                        <div class="app-name">
                                ...
                                <div class="col border-end">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="ven/images/apps/08.png" width="36" alt="">
                                        </div>
                                        <div class="app-name">
                                ...
                                <div class="col">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="ven/images/apps/09.png" width="36" alt="">
                                        </div>
                                        <div class="app-name">
                            ...
                            <div class="row row-cols-3 g-0">
                                <div class="col border-end">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="ven/images/apps/10.png" width="36" alt="">
                                        </div>
                                        <div class="app-name">
                                ...
                                <div class="col border-end">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="ven/images/apps/11.png" width="36" alt="">
                                        </div>
                                        <div class="app-name">
                                ...
                                <div class="col">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="ven/images/apps/12.png" width="36" alt="">
                                        </div>
                                        <div class="app-name">
                        ...
                        <div class="notify-list">
                            <div>
                                <a class="dropdown-item border-bottom py-2" href="javascript:;">
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="">
                                            <img src="ven/images/avatars/01.png" class="rounded-circle" width="45" height="45" alt="">
                                        </div>
                                        <div class="">
                            ...
                            <div>
                                <a class="dropdown-item border-bottom py-2" href="javascript:;">
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="">
                                            <img src="ven/images/apps/13.png" class="rounded-circle" width="45" height="45" alt="">
                                        </div>
                                        <div class="">
                            ...
                            <div>
                                <a class="dropdown-item border-bottom py-2" href="javascript:;">
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="">
                                            <img src="ven/images/apps/14.png" class="rounded-circle" width="45" height="45" alt="">
                                        </div>
                                        <div class="">
                            ...
                            <div>
                                <a class="dropdown-item border-bottom py-2" href="javascript:;">
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="">
                                            <img src="ven/images/avatars/06.png" class="rounded-circle" width="45" height="45" alt="">
                                        </div>
                                        <div class="">
                                            <h5 class="notify-title">Congratulations Jhon</h5>
                                            <p class="mb-0 notify-desc">Many congtars jhon. You have won the gifts.</p>
            ...
            <span class="badge-notify">8</span>
             ...
             <img src="ven/images/avatars/01.png" class="rounded-circle p-1 border" width="45" height="45" alt="">
          </a>
                    <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
                        <a class="dropdown-item  gap-2 py-2" href="javascript:;">
                            <div class="text-center">
                                <img src="ven/images/avatars/01.png" class="rounded-circle p-1 shadow mb-3" width="90" height="90" alt="">
    ...
    <aside class="sidebar-wrapper" data-simplebar="true">
        <div class="sidebar-header">
            <div class="logo-icon">
                <img src="ven/images/logo-icon.png" class="logo-img" alt="">
            </div>
                        ...
                        <div class="card-body">
                            <div class="">
                                <div class="d-flex align-items-center gap-2 mb-2">
                                    ...
                                    <img src="ven/images/apps/party-popper.png" width="24" height="24" alt="">
                                </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <img src="ven/images/apps/gift-box-3.png" width="100" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                                ...
                                <div class="d-flex flex-column gap-4">
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="social-icon d-flex align-items-center gap-3 flex-grow-1">
                                            <img src="ven/images/apps/17.png" width="40" alt="">
                                            <div>
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="social-icon d-flex align-items-center gap-3 flex-grow-1">
                                            <img src="ven/images/apps/twitter-circle.png" width="40" alt="">
                                            <div>
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="social-icon d-flex align-items-center gap-3 flex-grow-1">
                                            <img src="ven/images/apps/03.png" width="40" alt="">
                                            <div>
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="social-icon d-flex align-items-center gap-3 flex-grow-1">
                                            <img src="ven/images/apps/19.png" width="40" alt="">
                                            <div>
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="social-icon d-flex align-items-center gap-3 flex-grow-1">
                                            <img src="ven/images/apps/20.png" width="40" alt="">
                                            <div>
                ...
                <div class="col-12 col-lg-6 col-xxl-4 d-flex">
                    ...
                    <span class="material-icons-outlined fs-5">more_vert</span>
                            ...
                            <div class="d-flex flex-column gap-4">
                                <div class="d-flex align-items-center gap-3">
                                    <img src="ven/images/top-products/01.png" width="55" class="rounded-circle" alt="">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="ven/images/top-products/02.png" width="55" class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="ven/images/top-products/04.png" width="55" class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="ven/images/top-products/05.png" width="55" class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="ven/images/top-products/06.png" width="55" class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                ...
                <div class="col-12 col-lg-12 col-xxl-4 d-flex">
                    ...
                    <span class="material-icons-outlined fs-5">more_vert</span>
                            ...
                            <div class="d-flex flex-column gap-4">
                                <div class="d-flex align-items-center gap-3">
                                    <img src="ven/images/avatars/01.png" width="55" class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="ven/images/avatars/02.png" width="55" class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0">Ajay Sidhu</h6>
                                        <p class="mb-0">Sale: 879</p>
                                    </div>
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="ven/images/avatars/03.png" width="55" class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0">Ajay Sidhu</h6>
                                        <p class="mb-0">Sale: 879</p>
                                    </div>
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="ven/images/avatars/04.png" width="55" class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0">Ajay Sidhu</h6>
                                        <p class="mb-0">Sale: 879</p>
                                    </div>
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="ven/images/avatars/08.png" width="55" class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0">Ajay Sidhu</h6>
                                        <p class="mb-0">Sale: 879</p>
                                    </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center flex-row gap-3">
                                                    <div class="">
                                                        <img src="ven/images/apps/paypal.png" width="35" alt="">
                                                    </div>
                                                    <div class="">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center flex-row gap-3">
                                                    <div class="">
                                                        <img src="ven/images/apps/13.png" width="35" alt="">
                                                    </div>
                                                    <div class="">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center flex-row gap-3">
                                                    <div class="">
                                                        <img src="ven/images/apps/behance.png" width="35" alt="">
                                                    </div>
                                                    <div class="">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center flex-row gap-3">
                                                    <div class="">
                                                        <img src="ven/images/apps/07.png" width="35" alt="">
                                                    </div>
                                                    <div class="">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center flex-row gap-3">
                                                    <div class="">
                                                        <img src="ven/images/apps/05.png" width="35" alt="">
                                                    </div>
                                                    <div class="">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center flex-row gap-3">
                                                    <div class="">
                                                        <img src="ven/images/apps/apple.png" width="35" alt="">
                                                    </div>
                                                    <div class="">
        ...
        <div class="offcanvas-body p-0">
            <div class="order-list">
                <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                    <div class="order-img">
                        <img src="ven/images/orders/01.png" class="img-fluid rounded-3" width="75" alt="">
                    </div>
                ...
                <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                    <div class="order-img">
                        <img src="ven/images/orders/02.png" class="img-fluid rounded-3" width="75" alt="">
                    </div>
                    <div class="order-info flex-grow-1">
                ...
                <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                    <div class="order-img">
                        <img src="ven/images/orders/03.png" class="img-fluid rounded-3" width="75" alt="">
                    </div>
                    <div class="order-info flex-grow-1">
                ...
                <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                    <div class="order-img">
                        <img src="ven/images/orders/04.png" class="img-fluid rounded-3" width="75" alt="">
                    </div>
                    <div class="order-info flex-grow-1">
                ...
                <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                    <div class="order-img">
                        <img src="ven/images/orders/05.png" class="img-fluid rounded-3" width="75" alt="">
                    </div>
                    <div class="order-info flex-grow-1">
                ...
                <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                    <div class="order-img">
                        <img src="ven/images/orders/06.png" class="img-fluid rounded-3" width="75" alt="">
                    </div>
                    <div class="order-info flex-grow-1">
                ...
                <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                    <div class="order-img">
                        <img src="ven/images/orders/07.png" class="img-fluid rounded-3" width="75" alt="">
                    </div>
                    <div class="order-info flex-grow-1">
                ...
                <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                    <div class="order-img">
                        <img src="ven/images/orders/08.png" class="img-fluid rounded-3" width="75" alt="">
                    </div>
                    <div class="order-info flex-grow-1">
    ...
    <!--bootstrap js-->
    <script src="ven/js/bootstrap.bundle.min.js"></script>

    <!--plugins-->
    <script src="ven/js/jquery.min.js"></script>
    <!--plugins-->
    <script src="ven/plugins/perfect-scrollbar/js/perfect-scrollbar.js"></script>
    <script src="ven/plugins/metismenu/metisMenu.min.js"></script>
    <script src="ven/plugins/apexchart/apexcharts.min.js"></script>
    <script src="ven/plugins/simplebar/js/simplebar.min.js"></script>
    <script src="ven/plugins/peity/jquery.peity.min.js"></script>
    <script>
        $(".data-attributes span").peity("donut")
    </script>
    <script src="ven/js/dashboard2.js"></script>
    <script src="ven/js/main.js"></script>
