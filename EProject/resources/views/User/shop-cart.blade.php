            ...
            cartTotalsTable.innerHTML = `
                <tr>
                    ...
                    <td class="cart_total_amount">
                        <span class="font-lg fw-900 text-brand">$${subtotal.toFixed(2)}</span>
                    </td>
                </tr>
                <tr>
                    <td class="cart_total_label">Shipping</td>
                    <td class="cart_total_amount">
                        <i class="ti-gift mr-5"></i> $${shipping.toFixed(2)}
                    </td>
                </tr>
                <tr>
                    <td class="cart_total_label">Total</td>
                    <td class="cart_total_amount">
                        <strong><span class="font-xl fw-900 text-brand">$${total.toFixed(2)}</span></strong>
                    </td>
                </tr>
            `;
        }
