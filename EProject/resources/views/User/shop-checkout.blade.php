...
<body>
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"9497ea533f1be8c7","version":"2025.5.0","r":1,"token":"3aa9a3481f734e94bceb8bb1bd648ba1","serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}}}'
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateOrderSummary() {
        ...
        document.querySelector('.product-subtotal').textContent = `$${subtotal.toFixed(2)}`;
        document.querySelector('.font-xl.text-brand.fw-900').textContent = `$${subtotal.toFixed(2)}`;
    }
